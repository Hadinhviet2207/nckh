      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Công thức hóa học',
                stoneData['thanhPhanHoaHoc'] ?? 'Chưa có thông tin'),
            _buildInfoRow(
                'Nhóm đá', stoneData['nhomDa'] ?? 'Chưa có thông tin'),
            _buildInfoRow(
                'Độ cứng', stoneData['doCung'] ?? 'Chưa có thông tin'),
            _buildInfoRow('Mật độ', stoneData['matDo'] ?? 'Chưa có thông tin'),
          ],
        ),
      ),
    );
