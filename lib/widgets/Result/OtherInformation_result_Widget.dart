        ...
        child: Column(
          ...
          children: [
            ...
            _buildTitleWithDescription(
              ...
              description:
                  stoneData['thanhPhanKhoangSan'] ?? 'Không có thông tin',
            ),
            SizedBox(height: 12),
            _buildTitleWithDescription(
              title: '• Công dụng khoáng sản: ',
              description: stoneData['congDung'] ?? 'Không có thông tin',
            ),
            SizedBox(height: 12),
            _buildTitleWithDescription(
              title: '• Nơi phân bố:',
              description: stoneData['noiPhanBo'] ?? 'Không có thông tin',
            ),
            SizedBox(height: 12),
            _buildTitleWithDescription(
              title: '• Một số khoáng sản liên quan:',
              description:
                  stoneData['motSoKhoangSanLienQuan'] ?? 'Không có thông tin',
            ),
          ],
        ),
      ),
