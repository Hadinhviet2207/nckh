              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Hero(
                          ...
                          child: ClipRRect(
                            ...
                            child: (widget.stoneData['hinhAnh'] is List &&
                                    widget.stoneData['hinhAnh'].isNotEmpty)
                                ? Image.network(
                                    widget.stoneData['hinhAnh'][0],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                widget.stoneData['tenDa'] ?? 'Tên đá không rõ',
                              ...
                              Text(
                                'Loại đá: ${widget.stoneData['loaiDa'] ?? 'Không rõ'}',
                                style: const TextStyle(
                                  fontSize: 17,
                    ...
                    FrequentlyAskedQuestions(stoneData: widget.stoneData),
